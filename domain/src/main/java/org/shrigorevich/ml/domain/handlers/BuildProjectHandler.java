...
import org.shrigorevich.ml.domain.events.FinalizeProjectEvent;
import org.shrigorevich.ml.domain.events.StorageReplenishedEvent;
                ...
                if (struct instanceof TownInfra ti) {
                    try {
                        ...
                        if (project.isEmpty()) {
                            ...
                            BuildProject newProject = projectService.createProject(ti, structBlocks);
